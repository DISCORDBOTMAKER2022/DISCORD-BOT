    ...
    if (message.mentions.channels.first()) {
      ...
      if (data) {
        ...
        message.channel.send(
          `Unirse al canal establecido en ${message.mentions.channels.first()}`
        );
      ...
      if (data2) {
        ...
        return message.channel.send(`unirse al canal ha sido desactivado!`);
      } else if (!data2) {
        return message.channel.send(`Unirse al canal no está configurado!`);
      }
    }
  }
}