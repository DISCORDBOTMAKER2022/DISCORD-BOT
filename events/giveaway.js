    ...
    async (giveaway, reactor, messageReaction) => {
        ...
        try {
            ...
            reactor.send(
                new MessageEmbed()
                    .setTimestamp()
                    .setTitle(`Su Inscripción Aprobada || Tienes la oportunidad de ganar`)
                    .setDescription(
                        `Tu entrada a [This Giveaway](https://discord.com/channels/${giveaway.guildID}/${giveaway.channelID}/${giveaway.messageID}) has been approved!`
                    )
            ...
            reactor.send(new MessageEmbed()
                .setTimestamp()
                .setTitle(" Su entrada denegada | Entrada de la base de datos no encontrada y devuelta.")
                .setDescription(
                    `tu entrada a [This Giveaway](https://discord.com/channels/${giveaway.guildID}/${giveaway.channelID}/${giveaway.messageID}) has been denied as you did not join **${guildx.name}**`
                )
                .setFooter(ee.giveway)
            );
        }
