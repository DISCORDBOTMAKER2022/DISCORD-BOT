...
client.on('guildMemberAdd', async (member, message) => {
    ...
    if (data) {
        ...
        if (data2) {
            ...
            member.guild.channels.cache.get(channel).send(`Hey ${member} Bienvenido a ${member.guild.name}`)
            ...
            let embed2 = new MessageEmbed
                .setTitle("Welcome")
                .setDescription(
                    `${member}, Bienvenido a **${member.guild.name}**! ¡Esperamos que te guste nuestro servidor! ¡Disfruta de tu estadía aquí!`
                )
